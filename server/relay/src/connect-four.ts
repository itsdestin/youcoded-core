// Local copy of shared game logic for the relay server.
// The shared/connect-four.ts file can't be imported cross-package with ESM.
// Keep in sync with shared/connect-four.ts and src/renderer/game/connect-four.ts.
